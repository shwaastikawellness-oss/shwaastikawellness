...
export default function RethinkingSafetyPage() {
  return (
    <>
      <ReadingProgress />
      ...
      <main className="bg-[#fffdf8]">
        ...
        <nav className="blog-breadcrumb-bar" aria-label="Breadcrumb">
          <div className="blog-breadcrumb-inner">
            ...
            <span className="blog-breadcrumb-current">Rethinking Safety</span>
          </div>
        </nav>
        ...
        <ContinueReading currentSlug="rethinking-safety" />
